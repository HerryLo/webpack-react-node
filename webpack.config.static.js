...
var Build_Path = path.resolve(__dirname, './__build__/')
...
module.exports = {
    ...
    plugins: [
        new webpack.optimize.CommonsChunkPlugin({name: 'common', filename: './static/common.js'}),
        ...
        new ExtractTextPlugin('./static/[name].css') //你已经把哪个global的css打包到这个【name】。css里了   这个name就是entry的名字
    ],
    resolve: {
        extensions: [
